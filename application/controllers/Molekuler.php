...
class Molekuler extends CI_Controller{
...
foreach ($values as $key => $value) {
    ...
    //     $finalItems[] = $isiFinalItem;
     ...
     // filter array finalItems with date now
    // $finalItems = array_filter($finalItems, function($item) {
    //     return $item['Date_Received'] == date('Y-m-d');
    // });
    // return array finalItems
     //echo '<pre>';
     //print_r($finalItems);
